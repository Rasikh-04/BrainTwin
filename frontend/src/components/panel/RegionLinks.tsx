    ...
    <section className="space-y-2">
      ...
      {links.length === 0 ? (
        <div className="space-y-2">
          <p className="t-ctl rounded-md border border-dashed border-line bg-surface-0/40 px-2.5 py-2 leading-relaxed text-ink-faint">
          ...
          {hasStudies && (
            <button
              ...
              className="t-ctl inline-flex items-center gap-1 font-medium text-select transition-colors hover:text-select/80"
            >
        ...
        <ul className="space-y-1.5">
          {links.map((link) => (
            <li
              ...
              className="rounded-md border border-line bg-surface-0/50 px-2.5 py-2 transition-colors hover:border-line-strong"
            >
              <div className="flex items-center justify-between gap-2">
                ...
                {link.hasDemo && link.caseId && (
                  <button
                    ...
                    className="ident t-micro inline-flex items-center gap-1 rounded bg-select/15 px-1.5 py-0.5 uppercase tracking-wide text-select transition-colors hover:bg-select/25"
                  >
              ...
              {link.note && (
                <p className="t-ctl mt-1 leading-relaxed text-ink-muted">
                  {link.note}
                </p>
              )}
